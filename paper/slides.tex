...
\begin{frame}[plain]
  ...
  \begin{tikzpicture}[scale=0.62]
    ...
    \node[magic] at (7,0) {}; \node[mstar] at (7,0){};
    \node[magic] at (3,2) {}; \node[mstar] at (3,2){};
    \draw[pin, ftgreen!55!black] (4,1.3)--(4,2)--(5,2)--(5,2.7);
  \end{tikzpicture}
  \end{center}
...
\begin{frame}{A good \emph{placement} decides everything downstream}
  ...
  \begin{column}{0.5\textwidth}
    ...
    \begin{tikzpicture}[scale=0.62]
      ...
      \draw[pin,ftred,thick]
        (0.3,0)--(2,0)--(2,1)--(3,1)--(3,2)--(4,2)--(4,3)--(5,3)--(5,4)--(5.7,4);
      \node[ftred,font=\scriptsize] at (3,-0.9){long corridor $\to$ serialised steps};
    \end{tikzpicture}
  \end{column}
  \begin{column}{0.5\textwidth}
    ...
    \begin{tikzpicture}[scale=0.62]
      ...
      \node[magic] at (6,2){}; \node[mstar] at (6,2){};
      \node[corridor] at (5,2){};
      \draw[pin,ftgreen!55!black,thick] (4.3,2) -- (5.7,2);
      \node[ftgreen!55!black,font=\scriptsize] at (3,-0.9){short corridor $\to$ parallel routing};
    \end{tikzpicture}
  \end{column}
  \end{columns}
  ...
  \begin{tikzpicture}
    \node[draw=ftblue,fill=ftblue!8,rounded corners,inner sep=6pt,font=\small]{
      \textbf{Goal:} a cheap, geometry-aware placement that \emph{routes well} --- and stays routable.};
  \end{tikzpicture}
\end{frame}
...
\begin{frame}{Key idea: placement as a \emph{potential field}}
  ...
  \begin{column}{0.54\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \end{axis}
      \node[font=\scriptsize,ftorange!60!black] at (3.6,3.1){attract (peak)};
      \node[font=\scriptsize,ftblue] at (1.3,0.7){repel (valley)};
    \end{tikzpicture}
  \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Safe passage: never \emph{trap} a patch}
  ...
  \begin{column}{0.5\textwidth}
    ...
    \begin{tikzpicture}[scale=0.6]
      ...
      \node[data] at (1,1){}; \node[data] at (3,3){};
      \node[magic] at (5,0){}; \node[mstar] at (5,0){};
      \foreach \c in {(1,2),(1,3),(2,3),(2,1),(3,1),(4,1),(4,0)}
        \node[corridor] at \c{};
      \draw[pin,ftgreen!55!black] (1,1.3)--(1,3)--(2.7,3);
      \draw[pin,ftgreen!55!black] (1.3,1)--(4,1)--(4,0)--(4.7,0);
    \end{tikzpicture}\\[2pt]
