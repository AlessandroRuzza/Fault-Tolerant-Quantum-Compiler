...
We emphasize routing-step count and compile time because this work targets the
initial-placement layer; more global metrics such as space-time volume, logical
error rate, and factory utilization~\cite{kan2025sparo,hamada2026routing3d} remain
important downstream consequences, but are not the primary optimization target of
...
WISQ: points below
the diagonal favor our method, while the WISQ column of the table flags circuits
