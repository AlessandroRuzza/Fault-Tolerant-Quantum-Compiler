...
limitations are the greedy, single-pass nature of placement and the reliance on
hand-tuned field weights; a natural next step is to learn or jointly optimise
those weights, and to feed the field gradient back into the router so that
