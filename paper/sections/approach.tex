...
the tile we pick. The rest of this section makes that precise. We first define the
...
is non-negligible, and takes its limiting value beyond it---zero for an attractive
field, $w$ for a repulsive valley.
...
where magic states sit on the lattice boundary we also add a tuned constant to
every border tile---in practice a penalty that pushes patches inward, away from the
magic lane.
