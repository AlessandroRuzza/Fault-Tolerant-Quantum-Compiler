...
(repulsive) weight. Table~\ref{tab:params} lists the values we tuned for
each regime---the four combinations of weighting variant (coarse or fine) and
lattice geometry (cube or connectivity). All weights are border-independent except
\textsc{magic-high}, which varies with the placement border margin and is given
per border width.
