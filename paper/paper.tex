...
reserved spacing leaves more routing alternatives; we therefore treat
\emph{cube} as the default and \emph{connectivity} for when lattice
area is constrained.
...
\begin{figure}[t]
    ...
    \caption{Decomposition of the Gaussian placement score for one qubit: the
    ...
    its safe maximum---the tile where the qubit is committed.}
    \label{fig:fields}
\end{figure}
...
Figure~\ref{fig:frames} shows a layout forming.
