...
(repulsion-field) weight. Table~\ref{tab:params} lists the values we tuned for
each regime---the four combinations of weighting variant (coarse or fine) and
lattice geometry (cube or non-cube). All weights are border-independent except
...
\begin{table*}[t]
    ...
    \begin{tabular}{l cccc ccccc}
        ...
        \midrule
        coarse / cube    & 0.999999 & 1.5 & 0   & 0              & 0               & 0.2 & 0.2 & 0.2 & 1.6 \\
        coarse / noncube & 0.99999  & 1.5 & 2.0 & 0              & 0               & 0.2 & 0.8 & 0.8 & 0.2 \\
        fine / cube      & 0.999999 & 0.5 & 0   & $1^{\dagger}$  & $20^{\ddagger}$ & 3   & 1.6 & 0   & 0   \\
        fine / noncube   & 0.99999  & 0.5 & 1.5 & 0              & 3               & 1.6 & 0.4 & 0.4 & 0.2 \\
        \bottomrule
    \end{tabular}
