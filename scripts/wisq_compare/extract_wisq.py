...
Usage:
    python scripts/wisq_compare/extract_wisq.py data/results/best_gaussian_all_circuits_packing_wisq.csv
    python scripts/wisq_compare/extract_wisq.py data/results/*wisq*.csv
    python scripts/wisq_compare/extract_wisq.py data/results/*wisq*.csv --output best_wisq_per_circuit.csv
"""
