# wisqmin — connectivity + dascot_sa (config FISSA)


Nostro compiler forzato sulla griglia MINIMA di WISQ (s*), config fissa a priori: safe_passage=connectivity, routing=dascot_sa. Confronto same-grid.


Dati da: `connectivity_dascot_sa_wisqmin.csv` — **257 circuiti**.
...
| | | |
| **TOTALE VITTORIE NOSTRE** | **204 / 257 (79.4%)** | — |
| ↳ Noi completiamo, WISQ va in timeout | 16 / 257 (6.2%) | — |
| ↳ Noi vinciamo su steps (WISQ completa) | 88 / 257 (34.2%) | — |
| ↳ Pareggio su steps, noi più veloci | 100 / 257 (38.9%) | — |
...
| | | |
| **TOTALE VITTORIE NOSTRE** | **227 / 257 (88.3%)** | — |
...
| | | |
| **TOTALE VITTORIE NOSTRE** | **234 / 257 (91.1%)** | — |
...
| | | |
| **TOTALE VITTORIE NOSTRE** | **226 / 257 (87.9%)** | — |
...
| ↳ …ma anche noi sforiamo → nessun vincitore | 36 | — |
...
| | | |
| **TOTALE VITTORIE NOSTRE** | **214 / 257 (83.3%)** | — |
...
|--------|--------------------|----------------------------|-------------------------|------------------|---------------------|
| 12000 s (orig., asimm.) | 241 | 16 | 0 | 0 | **204 (79.4%)** |
| 1 ora | 203 | 50 | 0 | 4 | **219 (85.2%)** |
| 30 minuti | 193 | 59 | 0 | 5 | **227 (88.3%)** |
| 15 minuti | 177 | 73 | 0 | 7 | **234 (91.1%)** ⟵ picco |
| 10 minuti | 172 | 75 | 0 | 10 | **233 (90.7%)** |
| 5 minuti | 158 | 78 | 0 | 21 | **226 (87.9%)** |
| 1 minuto | 128 | 92 | 1 | 36 | **214 (83.3%)** |
...
|-----------|---|----------------|-----------------|---------------|-----|-----|
| **Tutti (inclusi timeout WISQ)** | 257 | 251 (97.7%) | 296× | 895× | 0.13× | 53659× |
...
| ↳ WISQ in timeout | 16 | 14 (87.5%) | 29× | 899× | 0.27× | 5329× |
...
Analisi su `connectivity_dascot_sa_wisqmin.csv`. La metrica primaria sono i **routing steps**, il tempo è secondario: concediamo un buffer ε sugli steps che cresce con l'ordine di grandezza del vantaggio di tempo.
...
Baseline (steps primario, tempo solo spareggio) = **204/257 = 79.4%**.

| ancora | α | loss recuperati | vittorie | % |
|---|---:|---:|---:|---:|
| 5% ⇄ 20× | 0.0384 | 11 | 215 | 83.7% |
| 5% ⇄ 50× | 0.0294 | 7 | 211 | 82.1% |
| 5% ⇄ 100× | 0.0250 | 7 | 211 | 82.1% |
| 5% ⇄ 150× | 0.0230 | 6 | 210 | 81.7% |
| 5% ⇄ 200× | 0.0217 | 6 | 210 | 81.7% |
| 5% ⇄ 300× | 0.0202 | 6 | 210 | 81.7% |
| 5% ⇄ 400× | 0.0192 | 6 | 210 | 81.7% |
| 5% ⇄ 500× | 0.0185 | 5 | 209 | 81.3% |
| 5% ⇄ 750× | 0.0174 | 5 | 209 | 81.3% |
| 5% ⇄ 1000× | 0.0167 | 5 | 209 | 81.3% |
| 5% ⇄ 1500× | 0.0157 | 5 | 209 | 81.3% |
| 5% ⇄ 2000× | 0.0151 | 5 | 209 | 81.3% |
| 5% ⇄ 2500× | 0.0147 | 5 | 209 | 81.3% |
| 5% ⇄ 3000× | 0.0144 | 5 | 209 | 81.3% |
| 5% ⇄ 4000× | 0.0139 | 5 | 209 | 81.3% |
| 5% ⇄ 5000× | 0.0135 | 5 | 209 | 81.3% |
...
| 46 | graphstate_n175 | 175 | 27×27 | 7 | 13 | 1.8571 | success | **WIN** | WISQ +veloce |
...
| 76 | ising_n5 | 5 | 5×5 | 6 | 4 | 0.6667 | success | LOSS | WISQ +veloce |
| 77 | ising_n50 | 50 | 15×15 | 4 | 12 | 3.0000 | success | **WIN** | noi +veloci |
| 78 | ising_n60 | 60 | 15×15 | 4 | 11 | 2.7500 | success | **WIN** | WISQ +veloce |
...
| 107 | qaoa_n5 | 5 | 5×5 | 18 | 14 | 0.7778 | success | LOSS | WISQ +veloce |
...
| 122 | qft_n150 | 150 | 25×25 | 3089 | 782 | 0.2532 | success | LOSS | noi +veloci |
...
| 126 | qft_n200 | 200 | 29×29 | 4203 | 982 | 0.2336 | success | LOSS | noi +veloci |
...
| 172 | synth_n50_d020_mix000_t030_hf000_hm001_r2_s0 | 50 | 19×19 | 67 | 61 | 0.9104 | success | LOSS | noi +veloci |
...
| 175 | synth_n50_d020_mix050_t030_hf000_hm001_r2_s1 | 50 | 19×19 | 74 | 75 | 1.0135 | success | **WIN** | noi +veloci |
| 176 | synth_n50_d020_mix100_t030_hf000_hm001_r2_s0 | 50 | 19×19 | 69 | 68 | 0.9855 | success | LOSS | noi +veloci |
| 177 | synth_n50_d020_mix100_t030_hf000_hm001_r2_s1 | 50 | 19×19 | 70 | 71 | 1.0143 | success | **WIN** | noi +veloci |
| 178 | synth_n50_d030_mix050_t030_hf000_hm001_r2_s0 | 50 | 19×19 | 105 | 108 | 1.0286 | success | **WIN** | noi +veloci |
| 179 | synth_n50_d040_mix000_t030_hf000_hm001_r2_s0 | 50 | 19×19 | 132 | 133 | 1.0076 | success | **WIN** | noi +veloci |
...
| 184 | synth_n50_d040_mix100_t030_hf000_hm001_r2_s1 | 50 | 19×19 | 139 | 146 | 1.0504 | success | **WIN** | noi +veloci |
| 185 | t_test | 8 | 5×5 | 130 | 110 | 0.8462 | success | LOSS | noi +veloci |
