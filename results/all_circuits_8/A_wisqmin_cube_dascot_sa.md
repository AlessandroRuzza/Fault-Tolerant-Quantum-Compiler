# wisqmin — cube + dascot_sa (config FISSA, same-grid)


FAIR. Config scelta a priori: safe_passage=cube, routing=dascot_sa. Entrambi i compiler sulla STESSA griglia: s* = la griglia MINIMA su cui WISQ riesce a instradare. Confronto same-grid sugli step. 256 circuiti (esclusi randomcircuit_n400 e bwt_n177).


Dati da: `wisqmin_cube_dascot_sa.csv` — **256 circuiti**.
...
| | | |
| **TOTALE VITTORIE NOSTRE** | **50 / 256 (19.5%)** | — |
| ↳ Noi completiamo, WISQ va in timeout | 5 / 256 (2.0%) | — |
| ↳ Noi vinciamo su steps (WISQ completa) | 17 / 256 (6.6%) | — |
| ↳ Pareggio su steps, noi più veloci | 28 / 256 (10.9%) | — |
| | | |
...
| | | |
| **TOTALE VITTORIE NOSTRE** | **52 / 256 (20.3%)** | — |
...
| | | |
| **TOTALE VITTORIE NOSTRE** | **54 / 256 (21.1%)** | — |
...
| 1 ora | 52 | 10 | 0 | 0 | **52 (20.3%)** |
| 30 minuti | 52 | 10 | 0 | 0 | **52 (20.3%)** |
| 15 minuti | 51 | 11 | 0 | 0 | **52 (20.3%)** |
| 10 minuti | 51 | 11 | 0 | 0 | **52 (20.3%)** |
| 5 minuti | 47 | 14 | 0 | 1 | **52 (20.3%)** |
| 1 minuto | 38 | 22 | 0 | 2 | **54 (21.1%)** ⟵ picco |
...
Analisi su `wisqmin_cube_dascot_sa.csv`. La metrica primaria sono i **routing steps**, il tempo è secondario: concediamo un buffer ε sugli steps che cresce con l'ordine di grandezza del vantaggio di tempo.
...
Baseline (steps primario, tempo solo spareggio) = **50/256 = 19.5%**.

| ancora | α | loss recuperati | vittorie | % |
|---|---:|---:|---:|---:|
| 5% ⇄ 20× | 0.0384 | 7 | 57 | 22.3% |
| 5% ⇄ 50× | 0.0294 | 7 | 57 | 22.3% |
| 5% ⇄ 100× | 0.0250 | 5 | 55 | 21.5% |
| 5% ⇄ 150× | 0.0230 | 5 | 55 | 21.5% |
| 5% ⇄ 200× | 0.0217 | 5 | 55 | 21.5% |
| 5% ⇄ 300× | 0.0202 | 5 | 55 | 21.5% |
| 5% ⇄ 400× | 0.0192 | 5 | 55 | 21.5% |
| 5% ⇄ 500× | 0.0185 | 5 | 55 | 21.5% |
| 5% ⇄ 750× | 0.0174 | 5 | 55 | 21.5% |
| 5% ⇄ 1000× | 0.0167 | 5 | 55 | 21.5% |
| 5% ⇄ 1500× | 0.0157 | 5 | 55 | 21.5% |
| 5% ⇄ 2000× | 0.0151 | 5 | 55 | 21.5% |
| 5% ⇄ 2500× | 0.0147 | 5 | 55 | 21.5% |
| 5% ⇄ 3000× | 0.0144 | 5 | 55 | 21.5% |
| 5% ⇄ 4000× | 0.0139 | 5 | 55 | 21.5% |
| 5% ⇄ 5000× | 0.0135 | 5 | 55 | 21.5% |
...
| 14 | bwt_n97 | 73 | 21×21 | 130803 | — | — | failed | timeout | noi +veloci |
...
| 68 | ising_n200 | 200 | 29×29 | 8 | 27 | 3.3750 | success | **WIN** | noi +veloci |
...
| 181 | synth_n50_d040_mix050_t030_hf000_hm001_r2_s1 | 50 | 19×19 | 150 | 151 | 1.0067 | success | **WIN** | noi +veloci |
| 182 | synth_n50_d040_mix100_t030_hf000_hm001_r2_s0 | 50 | 19×19 | 140 | 148 | 1.0571 | success | **WIN** | noi +veloci |
