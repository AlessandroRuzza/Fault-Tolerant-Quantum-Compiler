# wisqmin — ORACLE best-of-6 ⚠ NON FAIR


NON RIPORTABILE. Per ogni circuito e' scelta A POSTERIORI la migliore delle 6 config: e' solo un limite superiore. Per i risultati onesti usare i report A_*. 256 circuiti.


Dati da: `wisqmin_ORACLE_best_per_circuit.csv` — **256 circuiti**.
...
| ↳ Noi vinciamo su steps (WISQ completa) | 89 / 256 (34.8%) | — |
| ↳ Pareggio su steps, noi più veloci | 103 / 256 (40.2%) | — |
...
| | | |
| **TOTALE VITTORIE NOSTRE** | **230 / 256 (89.8%)** | — |
...
| | | |
| **TOTALE VITTORIE NOSTRE** | **237 / 256 (92.6%)** | — |
...
| | | |
| **TOTALE VITTORIE NOSTRE** | **236 / 256 (92.2%)** | — |
...
| ↳ …ma anche noi sforiamo → nessun vincitore | 32 | — |
...
|--------|--------------------|----------------------------|-------------------------|------------------|---------------------|
| 12000 s (orig., asimm.) | 241 | 15 | 0 | 0 | **207 (80.9%)** |
| 1 ora | 203 | 49 | 0 | 4 | **222 (86.7%)** |
| 30 minuti | 193 | 58 | 0 | 5 | **230 (89.8%)** |
| 15 minuti | 177 | 72 | 0 | 7 | **237 (92.6%)** ⟵ picco |
| 10 minuti | 172 | 74 | 0 | 10 | **236 (92.2%)** |
| 5 minuti | 158 | 77 | 0 | 21 | **229 (89.5%)** |
| 1 minuto | 128 | 95 | 1 | 32 | **221 (86.3%)** |
...
|-----------|---|----------------|-----------------|---------------|-----|-----|
| **Tutti (inclusi timeout WISQ)** | 256 | 251 (98.0%) | 293× | 1142× | 0.11× | 75572× |
...
| ↳ WISQ in timeout | 15 | 13 (86.7%) | 11× | 1398× | 0.63× | 8126× |
...
Baseline (steps primario, tempo solo spareggio) = **207/256 = 80.9%**.

| ancora | α | loss recuperati | vittorie | % |
|---|---:|---:|---:|---:|
| 5% ⇄ 20× | 0.0384 | 12 | 219 | 85.5% |
| 5% ⇄ 50× | 0.0294 | 9 | 216 | 84.4% |
| 5% ⇄ 100× | 0.0250 | 7 | 214 | 83.6% |
| 5% ⇄ 150× | 0.0230 | 6 | 213 | 83.2% |
| 5% ⇄ 200× | 0.0217 | 6 | 213 | 83.2% |
| 5% ⇄ 300× | 0.0202 | 6 | 213 | 83.2% |
| 5% ⇄ 400× | 0.0192 | 6 | 213 | 83.2% |
| 5% ⇄ 500× | 0.0185 | 5 | 212 | 82.8% |
| 5% ⇄ 750× | 0.0174 | 5 | 212 | 82.8% |
| 5% ⇄ 1000× | 0.0167 | 5 | 212 | 82.8% |
| 5% ⇄ 1500× | 0.0157 | 5 | 212 | 82.8% |
| 5% ⇄ 2000× | 0.0151 | 5 | 212 | 82.8% |
| 5% ⇄ 2500× | 0.0147 | 5 | 212 | 82.8% |
| 5% ⇄ 3000× | 0.0144 | 5 | 212 | 82.8% |
| 5% ⇄ 4000× | 0.0139 | 5 | 212 | 82.8% |
| 5% ⇄ 5000× | 0.0135 | 5 | 212 | 82.8% |
...
| 121 | qft_n150 | 150 | 25×25 | 1040 | 782 | 0.7519 | success | LOSS | noi +veloci |
...
| 125 | qft_n200 | 200 | 29×29 | 1395 | 982 | 0.7039 | success | LOSS | noi +veloci |
...
| 171 | synth_n50_d020_mix000_t030_hf000_hm001_r2_s0 | 50 | 19×19 | 64 | 61 | 0.9531 | success | LOSS | noi +veloci |
...
| 174 | synth_n50_d020_mix050_t030_hf000_hm001_r2_s1 | 50 | 19×19 | 73 | 75 | 1.0274 | success | **WIN** | noi +veloci |
| 175 | synth_n50_d020_mix100_t030_hf000_hm001_r2_s0 | 50 | 19×19 | 69 | 68 | 0.9855 | success | LOSS | noi +veloci |
| 176 | synth_n50_d020_mix100_t030_hf000_hm001_r2_s1 | 50 | 19×19 | 66 | 71 | 1.0758 | success | **WIN** | noi +veloci |
| 177 | synth_n50_d030_mix050_t030_hf000_hm001_r2_s0 | 50 | 19×19 | 104 | 108 | 1.0385 | success | **WIN** | noi +veloci |
| 178 | synth_n50_d040_mix000_t030_hf000_hm001_r2_s0 | 50 | 19×19 | 130 | 133 | 1.0231 | success | **WIN** | noi +veloci |
...
| 183 | synth_n50_d040_mix100_t030_hf000_hm001_r2_s1 | 50 | 19×19 | 138 | 146 | 1.0580 | success | **WIN** | noi +veloci |
