# wisqmin — cube + packing (config FISSA, same-grid)


FAIR. Config scelta a priori: safe_passage=cube, routing=packing. Entrambi i compiler sulla STESSA griglia: s* = la griglia MINIMA su cui WISQ riesce a instradare. Confronto same-grid sugli step. 256 circuiti (esclusi randomcircuit_n400 e bwt_n177).


Dati da: `wisqmin_cube_packing.csv` — **256 circuiti**.
...
| | | |
| **TOTALE VITTORIE NOSTRE** | **46 / 256 (18.0%)** | — |
...
| | | |
| **TOTALE VITTORIE NOSTRE** | **53 / 256 (20.7%)** | — |
...
| 5 minuti | 47 | 14 | 0 | 1 | **46 (18.0%)** |
| 1 minuto | 38 | 22 | 0 | 2 | **53 (20.7%)** ⟵ picco |
...
Analisi su `wisqmin_cube_packing.csv`. La metrica primaria sono i **routing steps**, il tempo è secondario: concediamo un buffer ε sugli steps che cresce con l'ordine di grandezza del vantaggio di tempo.
...
| 5% ⇄ 50× | 0.0294 | 15 | 55 | 21.5% |
| 5% ⇄ 100× | 0.0250 | 10 | 50 | 19.5% |
| 5% ⇄ 150× | 0.0230 | 10 | 50 | 19.5% |
| 5% ⇄ 200× | 0.0217 | 10 | 50 | 19.5% |
| 5% ⇄ 300× | 0.0202 | 8 | 48 | 18.8% |
| 5% ⇄ 400× | 0.0192 | 8 | 48 | 18.8% |
| 5% ⇄ 500× | 0.0185 | 8 | 48 | 18.8% |
| 5% ⇄ 750× | 0.0174 | 8 | 48 | 18.8% |
| 5% ⇄ 1000× | 0.0167 | 8 | 48 | 18.8% |
| 5% ⇄ 1500× | 0.0157 | 6 | 46 | 18.0% |
| 5% ⇄ 2000× | 0.0151 | 6 | 46 | 18.0% |
| 5% ⇄ 2500× | 0.0147 | 6 | 46 | 18.0% |
| 5% ⇄ 3000× | 0.0144 | 5 | 45 | 17.6% |
| 5% ⇄ 4000× | 0.0139 | 5 | 45 | 17.6% |
| 5% ⇄ 5000× | 0.0135 | 5 | 45 | 17.6% |
...
| 12 | bwt_n37 | 28 | 15×15 | 33621 | — | — | failed | timeout | noi +veloci |
...
| 75 | ising_n5 | 5 | 5×5 | 5 | 4 | 0.8000 | success | LOSS | noi +veloci |
...
| 106 | qaoa_n5 | 5 | 5×5 | 15 | 14 | 0.9333 | success | LOSS | noi +veloci |
...
| 121 | qft_n150 | 150 | 25×25 | 1230 | 782 | 0.6358 | success | LOSS | noi +veloci |
| 122 | qft_n175 | 175 | — | — | 898 | — | success | **MapFail** | — |
| 123 | qft_n18 | 18 | — | — | 100 | — | success | **MapFail** | — |
| 124 | qft_n20 | 20 | — | — | 110 | — | success | **MapFail** | — |
| 125 | qft_n200 | 200 | 29×29 | 1644 | 982 | 0.5973 | success | LOSS | noi +veloci |
...
| 171 | synth_n50_d020_mix000_t030_hf000_hm001_r2_s0 | 50 | 19×19 | 74 | 61 | 0.8243 | success | LOSS | noi +veloci |
...
| 174 | synth_n50_d020_mix050_t030_hf000_hm001_r2_s1 | 50 | 19×19 | 76 | 75 | 0.9868 | success | LOSS | noi +veloci |
| 175 | synth_n50_d020_mix100_t030_hf000_hm001_r2_s0 | 50 | — | — | 68 | — | success | **MapFail** | — |
| 176 | synth_n50_d020_mix100_t030_hf000_hm001_r2_s1 | 50 | 19×19 | 74 | 71 | 0.9595 | success | LOSS | noi +veloci |
| 177 | synth_n50_d030_mix050_t030_hf000_hm001_r2_s0 | 50 | 19×19 | 114 | 108 | 0.9474 | success | LOSS | noi +veloci |
| 178 | synth_n50_d040_mix000_t030_hf000_hm001_r2_s0 | 50 | 19×19 | 144 | 133 | 0.9236 | success | LOSS | noi +veloci |
| 179 | synth_n50_d040_mix000_t030_hf000_hm001_r2_s1 | 50 | 19×19 | 150 | 139 | 0.9267 | success | LOSS | noi +veloci |
...
| 183 | synth_n50_d040_mix100_t030_hf000_hm001_r2_s1 | 50 | 19×19 | 152 | 146 | 0.9605 | success | LOSS | noi +veloci |
...
| 192 | vqe_real_amp_n200 | 200 | 29×29 | 205 | 203 | 0.9902 | success | LOSS | noi +veloci |
| 193 | vqe_real_amp_n30 | 30 | — | — | 33 | — | success | **MapFail** | — |
| 194 | vqe_real_amp_n300 | 300 | — | — | 303 | — | success | **MapFail** | — |
| 195 | vqe_real_amp_n40 | 40 | 13×13 | 45 | 43 | 0.9556 | success | LOSS | noi +veloci |
...
| 209 | vqe_su2_n200 | 200 | 29×29 | 205 | 203 | 0.9902 | success | LOSS | noi +veloci |
| 210 | vqe_su2_n30 | 30 | — | — | 33 | — | success | **MapFail** | — |
| 211 | vqe_su2_n300 | 300 | — | — | 303 | — | success | **MapFail** | — |
| 212 | vqe_su2_n40 | 40 | 13×13 | 45 | 45 | 1.0000 | success | = | noi +veloci |
...
| 245 | wstate_n200 | 200 | 29×29 | 202 | 201 | 0.9950 | success | LOSS | noi +veloci |
